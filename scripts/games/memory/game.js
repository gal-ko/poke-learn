let memDiff = 'easy';
let memPool = [];
let memSelected = { name: null, img: null };
let memMatched = 0;
let memTotal = 0;
let memLocked = false;
let memFocusCol = 'name';
let memFocusIdx = 0;

const POKEMON_COLOR_HEX = {
...
let _memDragPid = null;
let _memDragType = null;
let _memGhost = null;
...
function memBindDrag() {
  ...
  board.addEventListener('drop', function(e) {
    ...
    const dropType = target.dataset.type;
